...
df1 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\glass1.csv", sep = ",", names = headers)
x1 = df1['Strain(mm/mm)']
y1 = df1['Force(N)']
stresslist1 = list()
arrx1 = np.array(x1)
...
df2 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\glass2.csv", sep = ",", names = headers)
x2 = df2['Strain(mm/mm)']
y2 = df2['Force(N)']
stresslist2 = list()
arrx2 = np.array(x2)
...
df3 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\glass3.csv", sep = ",", names = headers)
x3 = df3['Strain(mm/mm)']
y3 = df3['Force(N)']
stresslist3 = list()
arrx3 = np.array(x3)
