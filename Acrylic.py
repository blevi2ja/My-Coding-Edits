...
df1 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\acrylic1.csv", sep = ",", names = headers)
x1 = df1['Strain(in/in)']
y1 = df1['Force(lbf)']
stresslist1 = list()
arrx1 = np.array(x1)
...
df2 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\acrylic2.csv", sep = ",", names = headers)
...
df3 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\acrylic3.csv", sep = ",", names = headers)
x3 = df3['Strain(in/in)']
y3 = df3['Force(lbf)']
stresslist3 = list()
arrx3 = np.array(x3)
