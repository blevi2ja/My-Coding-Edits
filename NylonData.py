...
df1 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\BLEVINS_ZICAFOOSE_TESTS\BLEVINS_ZICAFOOSE_NYLON1.is_tens_RawData\Specimen_RawData_1.csv", sep = ",", names = headers)
x1 = df1['Strain(in/in)']
y1 = df1['Force(lbf)']
stresslist1 = list()
arrx1 = np.array(x1)
...
df2 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\BLEVINS_ZICAFOOSE_TESTS\BLEVINS_ZICAFOOSE_NYLON1.is_tens_RawData\Specimen_RawData_2.csv", sep = ",", names = headers)
x2 = df2['Strain(in/in)']
y2 = df2['Force(lbf)']
stresslist2 = list()
arrx2 = np.array(x2)
...
df3 = pd.read_table(r"C:\Users\Justin Blevins\Desktop\ENGR 298\MaterialsData\BLEVINS_ZICAFOOSE_TESTS\BLEVINS_ZICAFOOSE_NYLON1.is_tens_RawData\Specimen_RawData_3.csv", sep = ",", names = headers)
x3 = df3['Strain(in/in)']
y3 = df3['Force(lbf)']
stresslist3 = list()
arrx3 = np.array(x3)
